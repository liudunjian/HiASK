package com.hisense.hiask.main.widget;
...
import com.hisense.hitools.utils.AnimUtils;
...
public class TranslateUpDownBehavior extends FloatingActionButton.Behavior{
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        if (((dyConsumed > 0 && dyUnconsumed == 0) || (dyConsumed == 0 && dyUnconsumed > 0)) && !isAnimating && child.getVisibility() == View.VISIBLE) {
            ...
            AnimUtils.translateDown(child, new MyViewPropertyAnimatorListener() {
                @Override
            ...
            AnimUtils.translateUp(child, null);
        }
    }
