package com.hisense.hiask.recognizer;
...
import com.hisense.hiask.hiaudio.manager.AudioManager;
import com.hisense.hiask.recognizer.adapter.RecogEventAdapter;
...
/**
 * Created by liudunjian on 2018/6/15.
 */

public class AsstRecognizer {
    /**
     ...
     */
    public AsstRecognizer(Context context, IAsstRecognizerListener recogListener) {
     ...
     * @param eventListener
     */
    public AsstRecognizer(Context context, EventListener eventListener) {
        if (isInited) {
    ...
    public void loadOfflineEngine(Map<String, Object> params) {
        ...
        LogUtils.i("loadOfflineEngine params:" + json);
    ...
    public void start(Map<String, Object> params) {
        String json = new JSONObject(params).toString();
        LogUtils.i("asr params(识别参数，反馈请带上此行日志):" + json);
