package com.hisense.hiask.recognizer.adapter;

import com.baidu.speech.EventListener;
import com.baidu.speech.asr.SpeechConstant;
import com.hisense.hiask.recognizer.ErrorTranslation;
...
public class RecogEventAdapter implements EventListener {
    private IAsstRecognizerListener listener;

    public RecogEventAdapter(IAsstRecognizerListener listener) {
