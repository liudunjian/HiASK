...
public class CacheUtils {
    ...
    /**
     * get the total cached file size
     *
     * @return
     */

    public static double calculateCachedSize(Context context) {
        double size = 0;
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                size += getFolderSize(context.getExternalFilesDir(null));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /**
     * * clear /mnt/sdcard/android/data/com.xxx.xxx/file
     * @param context
     */
